...
export const Support = () => {
  return (
     ...
     <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto grid max-w-7xl gap-y-20 gap-x-8 px-6 lg:px-8 xl:grid-cols-3">
        <div className="max-w-2xl">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Miembros del Grupo de Trabajo</h2>
        ...
        <ul role="list" className="grid gap-x-8 gap-y-12 sm:grid-cols-2 sm:gap-y-16 xl:col-span-2">
          <li>
            <div className="flex items-center gap-x-6">
              ...
              <div>
                <h3 className="text-base font-semibold leading-7 tracking-tight text-gray-900">Nelson Gómez Mantilla</h3>
    ...
    <a type="button" className="btn btn-primary" href="/" autofocus>Página Principal    
    </a>
    </>
  )
}
